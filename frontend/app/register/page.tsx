    ...
    <main className="flex min-h-screen items-center justify-center bg-slate-950 px-6 py-12 text-white">
      <section className="w-full max-w-md">
        ...
        <p className="mt-3 text-sm leading-6 text-slate-300">
          Bắt đầu với tài khoản CareerOS AI để lưu tiến trình và mở rộng các tính năng MVP tiếp theo.
        </p>
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-5">
          <div>
            ...
            <input
              ...
              className="mt-2 w-full rounded-md border border-white/10 bg-white/5 px-4 py-3 text-white outline-none transition placeholder:text-slate-500 focus:border-cyan-300"
