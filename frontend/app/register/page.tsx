    ...
    <main className="flex min-h-screen items-center justify-center bg-slate-950 px-6 py-12 text-white">
      <section className="w-full max-w-md">
        ...
        <p className="mt-3 text-sm leading-6 text-slate-300">
          Bắt đầu với CareerOS AI để lưu tiến trình, phân tích CV/JD và xây dựng roadmap nghề nghiệp cá nhân.
        </p>
        ...
        <p className="mt-6 text-sm text-slate-300">
          Đã có tài khoản? <Link href="/login" className="font-semibold text-cyan-200 hover:text-cyan-100">Đăng nhập</Link>
        </p>
      </section>
    </main>
  );
